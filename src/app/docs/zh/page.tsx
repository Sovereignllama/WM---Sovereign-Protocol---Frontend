      ...
      <div className="max-w-3xl mx-auto px-4 py-6 pb-20">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-2">
            <h1 className="h1" style={{ color: '#d4ffe6', textShadow: '0 0 20px rgba(46,235,127,0.6), 0 0 40px rgba(46,235,127,0.3)' }}>文档</h1>
            <a href="/docs" className="text-sm text-[var(--muted)] hover:text-[var(--money-green)]">
              English →
            </a>
          </div>
        ...
        <div className="card mb-8">
          ...
          <ul className="space-y-2 text-[var(--muted)]">
            <li><a href="#overview" className="hover:text-[var(--money-green)]">→ 什么是 $overeign 协议？</a></li>
            <li><a href="#how-it-works" className="hover:text-[var(--money-green)]">→ 运作原理</a></li>
            <li><a href="#slamm" className="hover:text-[var(--money-green)]">→ SLAMM 引擎</a></li>
            <li><a href="#launch-types" className="hover:text-[var(--money-green)]">→ 发射类型</a></li>
            <li><a href="#lifecycle" className="hover:text-[var(--money-green)]">→ $overeign 生命周期</a></li>
            <li><a href="#fees" className="hover:text-[var(--money-green)]">→ 费用与收益</a></li>
            <li><a href="#governance" className="hover:text-[var(--money-green)]">→ 治理与解锁</a></li>
            <li><a href="#dead-pool" className="hover:text-[var(--money-green)]">→ Dead Pool — 失败项目保护</a></li>
            <li><a href="#genesis-nft" className="hover:text-[var(--money-green)]">→ $overeign NFT</a></li>
          </ul>
        </div>
        ...
        <div className="card mb-8" style={{ background: 'rgba(242, 183, 5, 0.05)', borderColor: 'rgba(242, 183, 5, 0.3)' }}>
          <h2 className="h3 mb-2" style={{ color: 'var(--money-green)' }}>当前协议费用</h2>
        ...
        <section id="overview" className="mb-10">
          <h2 className="h2 mb-4" style={{ color: 'var(--money-green)' }}>什么是 $overeign 协议？</h2>
        ...
        <section id="how-it-works" className="mb-10">
          <h2 className="h2 mb-4" style={{ color: 'var(--money-green)' }}>运作原理</h2>
          <div className="space-y-4 text-[var(--text-light)]">
            <p>协议的运作流程很简单：</p>
        ...
        <section id="slamm" className="mb-10">
          <h2 className="h2 mb-4" style={{ color: 'var(--money-green)' }}>SLAMM 引擎</h2>
          <div className="space-y-4 text-[var(--text-light)]">
            <p>
            ...
            <div className="card" style={{ background: 'rgba(242, 183, 5, 0.05)', borderColor: 'rgba(242, 183, 5, 0.2)' }}>
              <h3 className="h3 mb-3" style={{ color: 'var(--money-green)' }}>卖出机制</h3>
              <p className="text-[var(--muted)]">
        ...
        <section id="launch-types" className="mb-10">
          <h2 className="h2 mb-4" style={{ color: 'var(--money-green)' }}>发射类型</h2>
        ...
        <section id="lifecycle" className="mb-10">
          <h2 className="h2 mb-4" style={{ color: 'var(--money-green)' }}>$overeign 生命周期</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="card border-l-4" style={{ borderLeftColor: 'var(--profit)' }}>
              ...
              <p className="text-[var(--muted)]">
                ...
                <strong style={{ color: 'var(--money-green)' }}> $overeign NFT </strong>代表他们在池中的份额。在此阶段，
        ...
        <section id="fees" className="mb-10">
          <h2 className="h2 mb-4" style={{ color: 'var(--money-green)' }}>费用与收益</h2>
        ...
        <section id="governance" className="mb-10">
          <h2 className="h2 mb-4" style={{ color: 'var(--money-green)' }}>治理</h2>
          <div className="space-y-4 text-[var(--text-light)]">
            <p>
            ...
            <div className="card border-l-4" style={{ borderLeftColor: 'var(--money-green)' }}>
              <h3 className="h3 mb-3" style={{ color: 'var(--money-green)' }}>创作者控制</h3>
        ...
        <section id="dead-pool" className="mb-10">
          <h2 className="h2 mb-4" style={{ color: 'var(--money-green)' }}>Dead Pool — 失败项目保护</h2>
          <div className="space-y-4 text-[var(--text-light)]">
            <p>
        ...
        <section id="genesis-nft" className="mb-10">
          <h2 className="h2 mb-4" style={{ color: 'var(--money-green)' }}>$overeign NFT</h2>
          <div className="space-y-4 text-[var(--text-light)]">
            <p>
